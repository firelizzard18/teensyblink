...
LDFLAGS=-Wl,--gc-sections,--relax,--defsym=__rtc_localtime=1579708172 -lstdc++ -mthumb -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -fsingle-precision-constant -lm -L./build
...
CORE=mk20dx128.c main.cpp pins_teensy.c nonstd.c usb_desc.c usb_dev.c usb_mem.c usb_serial.c
